...
public enum UpdatedPlayerState {
	IDLE("idle", false, 20),
	...
	UpdatedPlayerState(String id, boolean paragliding, int defaultChange){
		this.id = id;
	...
	public static UpdatedPlayerState of(int meta){
		UpdatedPlayerState[] values = values();
